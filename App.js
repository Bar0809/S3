...
function App({ route }) {
  ...
  //   "Aleph-Regular": require("./assets/Alef-Regular.ttf"),
  // });

  // useEffect(() => {
  //   if (fontsLoaded) {
  //     // Font is loaded, force update to apply the font
  //     Text.defaultProps = Text.defaultProps || {};
  //     Text.defaultProps.style = { fontFamily: "Aleph-Regular" };
  //   }
  // }, [fontsLoaded]);

  // if (!fontsLoaded) {
  //   // Return a loading screen while the font is being loaded
  //   return null;
  // }
  return (
    <NavigationContainer>
      <Stack.Navigator
        screenOptions={{
          headerShown: false,
          // headerStyle: { fontFamily: "Aleph Regular" }, // Set the font for headers
        }}
      >
