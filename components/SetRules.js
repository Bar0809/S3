...
const SetRules = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        אז מה זה בעצם הרמזור?{" "}
      </Text>

      <Text style={{  fontSize: 18 }}>
        כל כיתה תקבל צבע מתוך צבעי הרמזור - ירוק, כתום או אדום בהתאם לדיווחים
        שדווחו על ידך בשבועיים האחרונים.{"\n"}
        כל אחת מהקטגוריות לדיווח תקבל צבע של רמזור לפי המוגדר מטה, הצבע של הכיתה
        יקבע לפי ממוצע צבעי הקטגוריות!
      </Text>
      <Text
        style={[
          styles.pageTitle,
            ...
            <View>
              ...
              {dietIsEditMode[0] ? (
                <View style={styles.editModeContainer}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleUpdateData("Diet", "green", "positive")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>עדכן</Text>
              ...
              {dietIsEditMode[1] ? (
                <View style={styles.editModeContainer}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleUpdateData("Diet", "green", "negative")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>עדכן</Text>
            ...
            <View>
              ...
              {moodIsEditMode[0] ? (
                <View style={styles.editModeContainer}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleUpdateData("Mood", "green", "positive")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>עדכן</Text>
              ...
              {moodIsEditMode[2] ? (
                <View style={styles.editModeContainer}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleUpdateData("Mood", "green", "negative")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>עדכן</Text>
            ...
            <View>
              ...
              {presenceIsEditMode[1] ? (
                <View style={styles.editModeContainer}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleUpdateData("Presence", "green", "late")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>ערוך</Text>
              ...
              {presenceIsEditMode[2] ? (
                <View style={styles.editModeContainer}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleUpdateData("Presence", "green", "absent")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>ערוך</Text>
            ...
            <View>
              ...
              {appearancesIsEditMode[2] ? (
                <View style={styles.editModeContainer}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleUpdateData("Appearances", "orange", "positive")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>עדכן</Text>
                ...
                <View style={styles.viewModeContainer}>
                  <Text style={styles.percentageText}>
                    {" "}
                    {appearancesPercentage[0]}% -{appearancesPercentage[2]}%{" "}
                  </Text>
                  <TouchableOpacity
                    onPress={() =>
                      handleEdit("Appearances", "orange", "positive")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>ערוך</Text>
              ...
              {appearancesIsEditMode[3] ? (
                <View style={styles.editModeContainer}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleUpdateData("Appearances", "orange", "nagetive")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>עדכן</Text>
                ...
                <View style={styles.viewModeContainer}>
                  <Text style={styles.percentageText}>
                    {appearancesPercentage[1]}% - {appearancesPercentage[3]}%
                  </Text>
                  <TouchableOpacity
                    onPress={() =>
                      handleEdit("Appearances", "orange", "nagetive")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>ערוך</Text>
              ...
              {dietIsEditMode[2] ? (
                <View style={styles.editModeContainer}>
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      handlePercentageChange(text, "Diet", "orange", "positive")
                    }
                    keyboardType="numeric"
                    placeholder="הכנס/י אחוז מינמלי לדיווחים חיוביים"
                    style={styles.textInput}
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleUpdateData("Diet", "orange", "positive")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>עדכן</Text>
                ...
                <View style={styles.viewModeContainer}>
                  <Text style={styles.percentageText}>
                    {" "}
                    {dietPercentage[0]}% -{dietPercentage[2]}%{" "}
                  </Text>
                  <TouchableOpacity
                    onPress={() => handleEdit("Diet", "orange", "positive")}
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>ערוך</Text>
                  </TouchableOpacity>
              ...
              {dietIsEditMode[3] ? (
                <View style={styles.editModeContainer}>
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      handlePercentageChange(text, "Diet", "orange", "negative")
                    }
                    keyboardType="numeric"
                    placeholder="הכנס/י אחוז מקסימלי לדיווחים שליליים"
                    style={styles.textInput}
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleUpdateData("Diet", "orange", "negative")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>עדכן</Text>
                ...
                <View style={styles.viewModeContainer}>
                  <Text style={styles.percentageText}>
                    {dietPercentage[1]}% - {dietPercentage[3]}%
                  </Text>
                  <TouchableOpacity
                    onPress={() => handleEdit("Diet", "orange", "negative")}
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>ערוך</Text>
                  </TouchableOpacity>
              ...
              {moodIsEditMode[3] ? (
                <View style={styles.editModeContainer}>
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      handlePercentageChange(text, "Mood", "orange", "positive")
                    }
                    keyboardType="numeric"
                    placeholder="הכנס/י אחוז מינמלי לדיווחים חיוביים"
                    style={styles.textInput}
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleUpdateData("Mood", "orange", "positive")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>עדכן</Text>
                ...
                <View style={styles.viewModeContainer}>
                  <Text style={styles.percentageText}>
                    {moodPercentage[0]}% - {moodPercentage[3]}%
                  </Text>
                  <TouchableOpacity
                    onPress={() => handleEdit("Mood", "orange", "positive")}
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>ערוך</Text>
                  </TouchableOpacity>
              ...
              {moodIsEditMode[4] ? (
                <View style={styles.editModeContainer}>
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      handlePercentageChange(text, "Mood", "orange", "meduim")
                    }
                    keyboardType="numeric"
                    placeholder="הכנס/י אחוז מקסימלי לדיווחים נטרליים"
                    style={styles.textInput}
                  ...
                  <TouchableOpacity
                    onPress={() => handleUpdateData("Mood", "orange", "meduim")}
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>עדכן</Text>
                  </TouchableOpacity>
                ...
                <View style={styles.viewModeContainer}>
                  <Text style={styles.percentageText}>
                    {" "}
                    {moodPercentage[1]}% - {moodPercentage[4]}%
                  </Text>
                  <TouchableOpacity
                    onPress={() => handleEdit("Mood", "orange", "meduim")}
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>ערוך</Text>
                  </TouchableOpacity>
              ...
              {moodIsEditMode[5] ? (
                <View style={styles.editModeContainer}>
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      handlePercentageChange(text, "Mood", "orange", "negative")
                    }
                    keyboardType="numeric"
                    placeholder="הכנס/י אחוז מקסימלי לדיווחים שליליים"
                    style={styles.textInput}
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleUpdateData("Mood", "orange", "negative")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>עדכן</Text>
                ...
                <View style={styles.viewModeContainer}>
                  <Text style={styles.percentageText}>
                    {moodPercentage[2]}%- {moodPercentage[5]}%
                  </Text>
                  <TouchableOpacity
                    onPress={() => handleEdit("Mood", "orange", "negative")}
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>ערוך</Text>
                  </TouchableOpacity>
            ...
            <View>
              ...
              {friendStatusIsEditMode[3] ? (
                <View style={styles.editModeContainer}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleUpdateData("FriendStatus", "orange", "positive")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>עדכן</Text>
                ...
                <View style={styles.viewModeContainer}>
                  <Text style={styles.percentageText}>
                    {friendStatusPercentage[0]}% - {friendStatusPercentage[3]}%
                  </Text>
                  <TouchableOpacity
                    onPress={() =>
                      handleEdit("FriendStatus", "orange", "positive")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>ערוך</Text>
              ...
              {friendStatusIsEditMode[4] ? (
                <View style={styles.editModeContainer}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleUpdateData("FriendStatus", "orange", "meduim")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>עדכן</Text>
                ...
                <View style={styles.viewModeContainer}>
                  <Text style={styles.percentageText}>
                    {" "}
                    {friendStatusPercentage[1]}% -{friendStatusPercentage[4]}%{" "}
                  </Text>
                  <TouchableOpacity
                    onPress={() =>
                      handleEdit("FriendStatus", "orange", "meduim")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>ערוך</Text>
              ...
              {friendStatusIsEditMode[5] ? (
                <View style={styles.editModeContainer}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleUpdateData("FriendStatus", "orange", "negative")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>עדכן</Text>
                ...
                <View style={styles.viewModeContainer}>
                  <Text style={styles.percentageText}>
                    {friendStatusPercentage[2]}% -{friendStatusPercentage[5]}%
                  </Text>
                  <TouchableOpacity
                    onPress={() =>
                      handleEdit("FriendStatus", "orange", "negative")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>ערוך</Text>
            ...
            <View>
              ...
              {presenceIsEditMode[3] ? (
                <View style={styles.editModeContainer}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleUpdateData("Presence", "orange", "presence")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>ערוך</Text>
                ...
                <View style={styles.viewModeContainer}>
                  <Text style={styles.percentageText}>
                    {presencePercentage[0]}% - {presencePercentage[3]}%
                  </Text>
                  <TouchableOpacity
                    onPress={() => handleEdit("Presence", "orange", "presence")}
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>עדכן</Text>
                  </TouchableOpacity>
              ...
              {presenceIsEditMode[4] ? (
                <View style={styles.editModeContainer}>
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      handlePercentageChange(text, "Presence", "orange", "late")
                    }
                    keyboardType="numeric"
                    placeholder="הכנס את אחוז האיחורים המקסימלי"
                    style={styles.textInput}
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleUpdateData("Presence", "orange", "late")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>ערוך</Text>
                ...
                <View style={styles.viewModeContainer}>
                  <Text style={styles.percentageText}>
                    {" "}
                    {presencePercentage[1]}% - {presencePercentage[4]}%{" "}
                  </Text>
                  <TouchableOpacity
                    onPress={() => handleEdit("Presence", "orange", "late")}
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>עדכן</Text>
                  </TouchableOpacity>
              ...
              {presenceIsEditMode[5] ? (
                <View style={styles.editModeContainer}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleUpdateData("Presence", "orange", "absent")
                    }
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>ערוך</Text>
                ...
                <View style={styles.viewModeContainer}>
                  <Text style={styles.percentageText}>
                    {" "}
                    {presencePercentage[2]}% - {presencePercentage[5]}%
                  </Text>
                  <TouchableOpacity
                    onPress={() => handleEdit("Presence", "orange", "absent")}
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>עדכן</Text>
                  </TouchableOpacity>
              ...
              {eventsIsEditMode[1] ? (
                <View style={styles.inputButtonContainer}>
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      handlePercentageChange(text, "Events", "orange", "")
                    }
                    keyboardType="numeric"
                    placeholder="הכנס מספר אירועים שליליים"
                    style={styles.textInput}
                  ...
                  <TouchableOpacity
                    onPress={() => handleUpdateData("Events", "orange", "")}
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>ערוך</Text>
                  </TouchableOpacity>
                ...
                <View style={styles.viewModeContainer}>
                  ...
                  <TouchableOpacity
                    onPress={() => handleEdit("Events", "orange", "")}
                    style={styles.button}
                  >
                    <Text style={styles.buttonText}>עדכן</Text>
                  </TouchableOpacity>
        ...
        {red && (
          <View>
            <Text style={[{ fontWeight: "bold" }]}>
              כדי לשנות את הערכים באיזור האדום, עליך לשנות את המידע באיזור הכתום{" "}
            </Text>
            <View>
              <Text style={{ fontWeight: "bold", fontSize: 18 }}>
                קטגוריית נראות:{" "}
              ...
              <View style={styles.viewModeContainer}>
                <Text style={styles.percentageText}>
                  {" "}
                  פחות מ-{appearancesPercentage[2]}%{" "}
                </Text>
              </View>
              ...
              <View style={styles.viewModeContainer}>
                <Text style={styles.percentageText}>
                  יותר מ- {appearancesPercentage[3]}%
                </Text>
              </View>
            </View>
            ...
            <View>
              ...
              <View style={styles.viewModeContainer}>
                <Text style={styles.percentageText}>
                  פחות מ- {friendStatusPercentage[3]}%
                </Text>
              </View>
              ...
              <View style={styles.viewModeContainer}>
                <Text style={styles.percentageText}>
                  {" "}
                  יותר מ- {friendStatusPercentage[4]}%{" "}
                </Text>
              </View>
              ...
              <View style={styles.viewModeContainer}>
                <Text style={styles.percentageText}>
                  יותר מ- {friendStatusPercentage[5]}%
                </Text>
              </View>
            </View>
