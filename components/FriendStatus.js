...
const FriendStatus = ({ route }) => {
  ...
  const createReport = async () => {
    ...
    if (querySnapshot.size > 0) {
      Alert.alert(
        "הוספת דיווח ",
        "שימו לב, יש דיווח מצב חברתי בתאריך זה למקצוע זה. האם ברצונכם להמשיך?",
        [
          {
            text: "לא",
          ...
          },
          {
            ...
            onPress: async () => {
              ...
              try {
                ...
                Alert.alert("", 'דו"ח מצב חברתי הוגש בהצלחה!');
  ...
  return (
    ...
    <View style={styles.title}>
      <Text style={styles.pageTitle}>דיווח מצב חברתי - {className}</Text>
    </View>
